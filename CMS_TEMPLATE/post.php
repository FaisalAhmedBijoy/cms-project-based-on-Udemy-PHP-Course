...
if (isset($_POST['create_comment'])) {
    ...
    VALUES ('{$the_comment_post_id}','{$comment_author}','{$comment_email}','{$comment_content}','Unapprove',now() ) WHERE post_id={$the_comment_post_id} ";
...
<?php
                ...
                $query="SELECT * FROM comments WHERE comment_id ={$the_comment_post_id} AND comment_status ='approved' ";
