...
<?php
        ...
        if (isset($_POST['update_post'])) {
           ...
           // echo "Foni Is Comming";
                    ...
                    $query="UPDATE posts SET post_title='{$post_title}',post_author='{$post_author}',post_category_id='{$post_category_id}',post_status='{$post_status}',post_tags='{$post_tags}',post_image='{$post_image}' WHERE post_id='{$query_post_id}' " ;

                    $update_post_query=mysqli_query($connection,$query) ;

                    confirmQuery($update_post_query);

                    echo "<p class='bg-succcess' > <a href='../post.php?p_id={$edit_post_id}' >View Post </a>   <p/>";
...
<form method="post" action="" enctype="multipart/form-data">
 ...
 -->
       ...
       <div class="form-group">
        ...
        <select id="" name="post_status" class="form-control" >
